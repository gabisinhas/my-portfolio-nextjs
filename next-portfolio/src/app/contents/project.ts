...
export const projects: Project[] = [
        ...
        {
        title: 'XBIS Implementation of Maintenance Module - Jul/23',
    ...
    {
        title: 'XBIS Back-End Upgrade of Cloudant DB - Nov/23',
